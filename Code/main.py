...
# Plot NDCG@10
sns.barplot(x=models, y=ndcg_scores, palette=["#4c72b0", "#55a868"], ax=axs[0])
...
# Plot Precision@10
sns.barplot(x=models, y=precision_scores, palette=["#4c72b0", "#55a868"], ax=axs[1])
...
# Plot Recall@10
sns.barplot(x=models, y=recall_scores, palette=["#4c72b0", "#55a868"], ax=axs[2])
